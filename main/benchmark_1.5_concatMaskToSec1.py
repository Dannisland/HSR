    ...
    with torch.no_grad():
        ...
        with open(filepath, 'w') as f:
            for i, batch in enumerate(tqdm(test_data_loader)):
                ...
                rev_noisy = torch.clamp(rev_noisy, 0, 1)
                ...
                rev_noisy = util.tensor2img(rev_noisy)
                ...
                if save:
                    ...
                    for x, last_fix in zip([hr, sec, sec_2, lr_1_4, lr_1_2,
                                            restored_hr, restored_hr2, recovered, recovered_2, rev_noisy],
                                           ["_hr.png", "_sec.png", "_sec_2.png",
                                            "_lr_1_4.png", "_lr_1_2.png", "_restored_hr.png",
                                            "_restored_hr2.png", "_recovered.png", "_recovered_2.png", "_rev_noisy.png"]):
                        # print(111)
