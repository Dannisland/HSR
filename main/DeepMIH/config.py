...
TRAIN_PATH_DIV2K = '/opt/data/xiaobin/MyDatasets/DIV2K/DIV2K_train_HR/'
VAL_PATH_DIV2K = '/opt/data/xiaobin/MyDatasets/DIV2K/DIV2K_valid_HR/'
...
# Saving checkpoints:
MODEL_PATH = '/opt/data/xiaobin/Project/AIDN/main/DeepMIH/results/'
checkpoint_on_error = True
SAVE_freq = 1


TEST_PATH = '/opt/data/xiaobin/Project/AIDN/main/DeepMIH/image/'
...
trained_epoch = 0 # 3000

pretrain = True
PRETRAIN_PATH = '/opt/data/xiaobin/Project/AIDN/main/DeepMIH/results/'
suffix_pretrain = 'model_checkpoint_05000'
PRETRAIN_PATH_3 = '/opt/data/xiaobin/Project/AIDN/main/DeepMIH/results/'
suffix_pretrain_3 = 'model_checkpoint_05000'