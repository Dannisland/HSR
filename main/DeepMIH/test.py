...
with torch.no_grad():
    ...
    for i, x in enumerate(datasets.testloader):
        ...
        # output_steg_2 = output_steg_2.cpu().numpy().squeeze() * 255
        # print(imp_map)
        # imp_map = imp_map * 1
        ...
        print("cover", abs(kornia.losses.psnr_loss(cover, output_steg_1, 1)))
        print("cover2", abs(kornia.losses.psnr_loss(cover, output_steg_2, 1)))
        print("secret_1", abs(kornia.losses.psnr_loss(secret_1, rev_secret_1, 1)))
        print("secret_2", abs(kornia.losses.psnr_loss(secret_2, rev_secret_2, 1)))
