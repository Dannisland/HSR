...
def test(model, revealNet, revealNet_2, revealNet_3, test_data_loader, scale=4, save=False, data_name=None):
        ...
        with open(filepath, 'w') as f:
            for i, batch in enumerate(tqdm(test_data_loader)):
                ...
                if save:
                    ...
                    for x, last_fix in zip([hr, sec, sec_2, sec_3,
                                            lr_1_8, lr_1_4, lr_1_2,
                                            restored_hr, restored_hr2, restored_hr3,
    ...
    logger.info('========> SR: \n'
                ...
                '========> Recover: \n'
                'PSNR_Rev_1_4: {psnr_meter_rev_1_8.avg:.2f}\n'
                'SSIM_Rev_1_4: {ssim_meter_rev_1_8.avg:.4f}\n'
